...
SCENARIOS = [
    ...
    {"title": "大学・専攻・将来（化学＋海外旅行の人设）",
     "turns": [
         "学生のころは何を勉強していたんですか？",
         "化学って難しそうですね。実験とかは好きでしたか？",
         "卒業してから海外には行かれました？",
         "どこか行ってみたい国はありますか？",
         "いいですね、その国の何に惹かれるんですか？",
     ]},
    {"title": "朝の習慣・お風呂（早起き苦手＋長風呂の人设）",
     "turns": [
         "朝は強いほうですか？",
         "休日でもやっぱり早起きは苦手ですか？",
         "お風呂派ですか、シャワー派ですか？",
         "へえ、長風呂なんですね。湯船では何をして過ごすんですか？",
         "リラックスできそうでいいですね！",
     ]},
    {"title": "长对话・话题切换后回指（8轮，长上下文压力测试）",
     "turns": [
         "はじめまして！今日はよろしくお願いします。",
         "さっそくですが、週末は何をして過ごすことが多いですか？",
         "いいですね。ちなみに私、来週から福岡に旅行に行くんです。",
         "おすすめの食べ物ってありますか？",
         "ありがとうございます！ところで、甘いものは好きですか？",
         "なるほど。ところで話は変わりますが、運動はよくされますか？",
         "そういえば、さっき私が来週どこへ旅行に行くと言ったか、覚えていますか？",
         "ばっちりですね！楽しみです。",
     ]},
]
